...
const LiveCard = ({ liveItem }) => {
  ...
  // Destructure props
  const { title, category, upvotes, description, comments, id } = liveItem;
  ...
  return (
    <div className='req-card'>
      <div className='req-card-top-color req-card-top-live'></div>
      <div className='req-card-title'>
        <div className='live-dot dot'></div>
